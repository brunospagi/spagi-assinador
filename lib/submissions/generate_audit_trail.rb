...
module Submissions
  module GenerateAuditTrail
    ...
    def build_audit_trail(submission)
      ...
      composer.column(columns: 1) do |column|
        ...
        if show_verify?(submission)
          column.formatted_text([{ link: 'https://assinador-validacao.spagisistemas.com.br/', text: I18n.t('verify'), style: :link }],
      ...
      composer.draw_box(divider)
      #IMAGEM RODAPE
      composer.image(PdfIcons.logo_icp, width: 40, height: 42, position: :float)
      composer.formatted_text([
        { text: 'Documento assinado com validade jurídica.', font: [FONT_NAME, { variant: :bold }] }
        ],
        font_size: 10,
        padding: [3, 0, 0, 7]) 
      composer.formatted_text([
        { text: 'Para conferir a validade, acesse ', font: [FONT_NAME] },
        { text: 'https://assinador-validacao.spagisistemas.com.br/', font: [FONT_NAME], fill_color: 'blue', link: 'https://assinador-validacao.spagisistemas.com.br/' },
        { text: ' e utilize a senha gerada pelos signatários ou envie este arquivo em PDF.', font: [FONT_NAME] }
        ],
        font_size: 10,
        padding: [0, 0, 0, 7])
      composer.formatted_text([
        { text: 'As assinaturas digitais e eletrônicas têm validade jurídica prevista na Medida Provisória no. 2200-2 / 2001', font: [FONT_NAME] }
        ],
        font_size: 10,
        padding: [0, 0, 0, 0])
      composer.formatted_text([
        { text: "Este Log é exclusivo e deve ser considerado parte do documento nº #{$document_id}, com os
        efeitos prescritos nos Termos de Uso do Assinador Spagi Sistemas, disponível em https://assinador.spagisistemas.com.br/ .", font: [FONT_NAME] }
        ],
        font_size: 8,
        padding: [2, 0, 5, 0]) 
      composer.draw_box(divider)
    ...
    def add_logo(column, _submission = nil)
      ...
      column.formatted_text([{ text: 'Assinatura Digital',
